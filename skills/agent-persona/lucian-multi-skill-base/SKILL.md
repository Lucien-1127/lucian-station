...
| 🖥 GCP | `google-cloud-platform` | 1.0.0 | `devops/google-cloud-platform` |
| 🖥 GCP 學習 | `gcp-learning` | 1.1.0 | `devops/gcp-learning` |
| 📁 FileOps | `fileops-v2` | 2.0.0 | `fileops/fileops-v2` |
| 📘 SkillDev | `skilldev-v2` | 2.2.0 | `skilldev/skilldev-v2` |
| 📘 自學 | `self-learning` | 1.1.0 | `agent-persona/self-learning` |
...
| 🔬 AI 學習 | `ai-learning` | 1.1.0 | `research/ai-learning` |
| 👨‍⚖️ Legal | `zhiyan-legal` | 3.06 | `research/zhiyan-legal` |
